...
`loc` บอกว่า “ส่วนใดของ Legend” จะไปยึดกับจุดนั้น ส่วน `bbox_to_anchor` บอก “จุดยึดอยู่ที่ไหน”
...
ไม่ควรสร้าง Legend หลายสิบรายการเพื่อแทนความชื้นทุกค่า เพราะผู้ชมต้องการ Scale ต่อเนื่องจาก Colorbar
