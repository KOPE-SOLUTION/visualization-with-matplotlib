...
Histogram ช่วยเปลี่ยนข้อมูลเซนเซอร์จำนวนมากให้เป็นภาพการกระจายที่อ่านง่าย และใช้ตรวจสอบค่าปกติ ความผันผวน จุดผิดปกติ รวมถึงรูปแบบการทำงานหลายสถานะของเครื่องจักรได้
...
แต่ละหัวข้อจะนำคำศัพท์เหล่านี้ไปใช้และอธิบายเพิ่มเติม
...
กราฟควรแสดงกลุ่มหลักใกล้ 26 °C และกลุ่มขนาดเล็กใกล้ 31.5 °C ซึ่งอาจหมายถึงอีกสถานะการทำงานหนึ่งของเครื่องจักร
...
> ตัวอย่างจาก Matplotlib รุ่นเก่าบางแห่งใช้ `normed=True` แต่รุ่นปัจจุบันควรใช้ `density=True`
---

## 6. เปรียบเทียบสถานะการสั่นสะเทือน

ตัวอย่างนี้ใช้ข้อมูล RMS vibration จากมอเตอร์ในสถานะปกติและสถานะเตือน
...
- **Dashboard** แสดงข้อมูลเพื่อประกอบการตัดสินใจ
...
ตัวอย่างต่อไปจำลองความสัมพันธ์ระหว่างกระแสไฟของมอเตอร์กับอุณหภูมิ
